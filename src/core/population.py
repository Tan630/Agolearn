...
class Genome(ABC, Generic[R]):
    ...
    def copy(self) -> Self:
        """!Copy the solution.
            ...
            TODO Consider using deepcopy instead. Doing so requires a complete refactor.
                It warrants discussion, however, if copying does not have to be deep.
        """
